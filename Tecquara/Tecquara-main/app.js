...
// Controlar la seccion de tecnologia
document.addEventListener('DOMContentLoaded', () => {
    ...
    const contTecnologias = document.getElementById('tecnologias');
    const contHerramientas = document.getElementById('herramientas');
  
    btnTecnologias.addEventListener('click', () => {
      contTecnologias.style.display = 'flex';
      contHerramientas.style.display = 'none';
      btnTecnologias.classList.add('activo');
      btnHerramientas.classList.remove('activo');
    });
  
    btnHerramientas.addEventListener('click', () => {
      contTecnologias.style.display = 'none';
      contHerramientas.style.display = 'flex';
      btnHerramientas.classList.add('activo');
      btnTecnologias.classList.remove('activo');
    });
  });